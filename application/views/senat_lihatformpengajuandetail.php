...
<div class="main-panel">
    ...
    echo "
     ...
     echo "
        <div class='col-sm-7' style=''>
            ...
            <a href='".base_url()."index.php/kelolaberkas/berkasdisetujui?id=".$idpengajuan."' class='btn btn-info' style='border-radius:0px;'>Ijinkan Berkas Pengajuan</a>
  ...
  <strong>Perhatian!</strong> Isikan Keterangan Revisi Pada Kolom Dibawah.
            ...
            echo form_open('kelolaberkas/tolakberkassenat');
            echo"        
