...
<div class="main-panel">
        ...
        <div class="col-sm-12" style="background: #ecf0f1;"> 
            <h3 style="text-align:center; margin-bottom:50px;">FORM PERNYATAAN<br>   MELAKSANAKAN PENUNJANG TUGAS DOSEN </h3>
            ...
            <div class="panel panel-default" style=" border-left: 6px solid #dd5209; ">
                <div class="panel-heading" style="color:#dd5209; "><b>Form Pengisian Kegiatan</b></div>
                    <div class="panel-body">
                          ...
                          <?php echo form_open_multipart('keloladosen/submitkegiatanpenunjang');?>
...
$(document).ready(function () {
    $('#combox1 select').change(function () {
        ...
        $.ajax({
            url: "<?=base_url()?>index.php/keloladosen/formgeturaiankegiatanpenunjang/",       //memanggil function controller dari url
            async: false,
...
$(document).ready(function () {
    $('#combox2 select').change(function () {
         var no  = $(this).val();
            ...
            $.ajax({
            url: "<?=base_url()?>index.php/keloladosen/formgeturaiankegiatanpenunjangdetail/",       //memanggil function controller dari url
            async: false,
            type: "POST",     //jenis method yang dibawa ke function
