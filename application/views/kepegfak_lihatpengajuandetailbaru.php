...
?>
   ...
   <table cellspacing="0">
    ...
    foreach($data_penelitian as $row){
        ...
        $arrlength = count($row);
        $getnilai=$m_berkas->getnilaireviewer($row->IDTriDharma);
    ...
    echo 
       ...
       <tr>
        ...
        echo "
            ...
            <td><a href='".base_url()."index.php/kelolaberkas/nilaireviewer?idpengajuan=".$row->IDTriDharma."' class='btn btn-warning btn-sm' style='border-radius:0;'>
