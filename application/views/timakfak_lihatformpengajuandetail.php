...
<div class="sidebar-wrapper">
            ...
            <ul class="nav" style="margin-top:0px;">
                <li >
                    <a href="<?php echo base_url();?>index.php/keloladosen/dashboardtimakfak">
                        <i class="ti-panel"></i>
                        <p>Dashboard</p>
                    </a>
                </li>
                 <li class="active">
                    <a href="<?php echo base_url();?>index.php/kelolaberkas/tampilberkasbarutimakfak">
                        <i class="ti-file"></i>
                        <p>Berkas</p>
                    </a>
                </li>
   ...
   <table cellspacing="0">
    ...
    echo 
       ...
       <tr>
        ...
        <td><a href='".base_url()."index.php/kelolaberkas/nilaikegiatanpendidikan?idpengajuan=".$row->IDTriDharma."' class='btn btn-warning btn-sm' style='border-radius:0;'>
    ...
    echo 
       ...
       <tr>
        <td></td>
         ...
         <td><a href='".base_url()."index.php/kelolaberkas/nilaikegiatanpenelitian?idpengajuan=".$row->IDTriDharma."' class='btn btn-warning btn-sm' style='border-radius:0;'>
           <i class='ti-pencil-alt'></i>
            </a>
            </td>
    ...
    echo 
       ...
       <tr>
        <td></td>
         ...
         <td><a href='".base_url()."index.php/kelolaberkas/nilaikegiatanpengabdian?idpengajuan=".$row->IDTriDharma."' class='btn btn-warning btn-sm' style='border-radius:0;'>
           <i class='ti-pencil-alt'></i>
            </a>
            </td>
...
$getnilai=$m_berkas->getnilaikegiatan($row->IDTriDharma);
    ...
    echo 
       ...
       <tr>
        <td></td>
         ...
         <td><a href='".base_url()."index.php/kelolaberkas/nilaikegiatanpenunjang?idpengajuan=".$row->IDTriDharma."' class='btn btn-warning btn-sm' style='border-radius:0;'>
           <i class='ti-pencil-alt'></i>
            </a>
            </td>
    ...
    "
             ...
             <a href='<?php echo base_url();?>index.php/kelolaberkas/submitpenilaianfakultas?idpengajuan=<?php echo $this->input->get('idpengajuan')?>' class='btn btn-warning' style='border-radius:0px;'>Submit Penilaian</a> 
                </div>  
