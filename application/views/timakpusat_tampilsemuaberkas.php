             ...
             <table width="100%" class="table table-striped table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        echo"
                                        <td>
                                        <a href='".base_url()."index.php/kelolaberkas/lihatformpengajuandetailpenilaipusat?idpengajuan=".$row->IDPengajuan."' class='btn btn-info' style='border-radius:0px;'>Detail</a>";
