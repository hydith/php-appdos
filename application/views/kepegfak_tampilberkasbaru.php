             ...
             <table width="100%" class="table table-striped table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        echo"
                                        <td>
                                        <a href='".base_url()."index.php/kelolaberkas/lihatpengajuandetailbaru?idpengajuan=".$row->IDPengajuan."' class='btn btn-info' style='border-radius:0px;'>Detail</a></td>";
                                        }
                                        else if($idstatus!=5&&$idstatus!=9){
                                        echo"
                                        <td>
                                        <a href='".base_url()."index.php/kelolaberkas/lihatformpengajuandetail?idpengajuan=".$row->IDPengajuan."' class='btn btn-info' style='border-radius:0px;'>Detail</a></td>";
                                        }
                                        elseif($idstatus==9){
                                            echo"
                                        <td>
                                        <a href='".base_url()."index.php/kelolaberkas/lihatformpengajuanternilai?idpengajuan=".$row->IDPengajuan."' class='btn btn-info' style='border-radius:0px;'>Detail</a></td>"; 
                                        }
                                        else{
                                            echo"<td></td>";
                                        }
